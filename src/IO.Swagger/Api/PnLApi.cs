...
namespace IO.Swagger.Api
{
    ...
    /// </summary>
    public interface IPnLApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class PnLApi : IPnLApi
    {
        private IO.Swagger.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="PnLApi"/> class.
        /// </summary>
        /// <returns></returns>
        public PnLApi(String basePath)
        {
        ...
        /// <returns></returns>
        public PnLApi(IO.Swagger.Client.Configuration configuration = null)
        {
